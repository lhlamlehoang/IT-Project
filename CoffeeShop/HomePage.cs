    ...
    public partial class HomePage : Form
    {
        ...
        private void bt_SCart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("This phone number has not been created!", "Ordering", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else
                {
                    if (verif())
            ...
            {
                MessageBox.Show(ex.Message, "Ordering", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void bt_Signin_Click(object sender, EventArgs e)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Please choose who real you are", "Login", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        ...
        private void btguest_Click_1(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count == 0)
            {
                MessageBox.Show("No item selected!", "Ordering", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
